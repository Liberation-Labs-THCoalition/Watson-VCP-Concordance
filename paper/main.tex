...
\begin{enumerate}
    ...
    \item \textbf{VCP self-report is fragile:} mean ICC $= 0.53$ across two models (2/20 dimension-model pairs $> 0.70$), parser contamination silently fabricated 18\% of ratings, and the 10 dimensions collapse to 2--4 independent factors.
